...
class notConfirmDetails extends Component {
  state = {
    // loading: true,
    // redirect: false
  };
      ...
      <div className="all-leaveDetails " style={{ background: "#F0F0F0" }}>
        ...
        <div className="in-leaveDetails">
            ...
            >
              <Col span={24}>
                <h4 style={{ color:'#BFBFBF',padding:'5px'}}>
                    <Input  disabled placeholder="ไม่อนุญาตให้ลาในวันนี้" />
                </h4>
              </Col>
            </Row>
          </div>
          ...
          >
            ...
            <Link to="/HistoryApproval">
              <div style={{ marginLeft:'' ,padding:'10px'}}>
...
export default notConfirmDetails;
